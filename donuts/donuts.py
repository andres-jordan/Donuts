...
class Donuts(object):
    ...
    def __init__(self, refimage, image_ext=0, exposure='EXPTIME',
                 ...
                 overscan_width=0, upper_trim=0,border=64, ntiles=32, image_class=Image):
        ...
        upper_trim: int, optional
            Width of region to trim above in pixels. Default is 0.
        border : int, optional
